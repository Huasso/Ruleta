...
public class RepositorioArchivo implements IRepositorioResultados {
    ...
    public void cargarDatos() {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(NOMBRE_ARCHIVO))) {
            ...
            System.out.println("Repositorio Archivo: No se encontró archivo previo. Se creará uno nuevo.");
            historialPersistente = new ArrayList<>();
        } catch (IOException | ClassNotFoundException e) {
            System.err.println("Repositorio Archivo: Error al leer el archivo. Se usará historial vacío. " + e.getMessage());
            historialPersistente = new ArrayList<>();
        }
    }
